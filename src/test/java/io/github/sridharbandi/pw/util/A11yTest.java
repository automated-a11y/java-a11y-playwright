...
public class A11yTest {
    ...
    public void testHtmlAxeExecute() throws Exception {
        ...
        a11y.jsonReports(Engine.AXE, io.github.sridharbandi.pw.modal.axe.Issues.class);
